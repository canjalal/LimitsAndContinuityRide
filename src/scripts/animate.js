...
export class Ashley {
    constructor(xi, yi, chart) { // refactor to remove xi and yi bc they aren't needed
        ...
        this.caption.style.width = window.innerWidth > 700 && window.innerHeight > 375 ? '300px' : '200px';
        this.caption.style.height = window.innerWidth > 700 && window.innerHeight > 375 ? '150px' : '100px'; 
        this.caption.style.fontSize = window.innerWidth > 700 && window.innerHeight > 375 ? '22px' : '14px';
